# ============================================================================
# Dockerfile — aumos-agent-framework
# Multi-stage build for production-ready agent framework service
# ============================================================================
...
# Start service
CMD ["uvicorn", "aumos_agent_framework.main:app", "--host", "0.0.0.0", "--port", "8000", "--workers", "1"]
